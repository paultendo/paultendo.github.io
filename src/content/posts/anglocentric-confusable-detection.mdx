...
12. **This post**: the coverage gap in confusable detection
13. [248 cross-script confusable pairs that no standard covers](/posts/confusable-vision-cross-script/)
