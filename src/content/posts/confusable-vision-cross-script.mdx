...
*[confusable-vision](https://github.com/paultendo/confusable-vision) is MIT-licensed. [namespace-guard](https://github.com/paultendo/namespace-guard) (zero dependencies, MIT) provides `skeleton()`, `areConfusable()`, and `confusableDistance()` for identifier-level detection, plus `canonicalise()` and `scan()` for LLM pipeline preprocessing.*
