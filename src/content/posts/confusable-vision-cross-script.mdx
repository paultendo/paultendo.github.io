...
This post describes cross-script discoveries from the SSIM (pixel-based) pipeline: 248 novel pairs from 23.6 million comparisons. A subsequent [RaySpace](/posts/rayspace-methodology/) scan using vector-outline raycasting found 249,976 unique confusable pairs across the same 12 scripts, including 305% more cross-script discoveries than SDF alone. The cross-script findings below were confirmed and greatly extended.
