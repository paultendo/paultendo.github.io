...
**Denial of Spend** *(noun)*: an attack that cannot degrade a service but can inflate the cost of running it. The confusable analogue of DDoS. The requests are normal-sized, from legitimate accounts, processing real documents. The inflation is invisible until the invoice arrives.
...
9. **This post**: Denial of Spend: Unicode confusables as a billing attack on LLM pipelines
