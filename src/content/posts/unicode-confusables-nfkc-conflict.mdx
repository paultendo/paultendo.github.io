...
date: "2026-02-21"
updated: "2026-02-25"
updateNote: "Clarified that NFKC is specifically recommended for identifiers, not general web text -- NFC is the W3C standard for most web content. Thanks to joshdata on HN for the correction. Previously: corrected table values and rewrote practical impact section."
...
Here's the wrinkle. If your application also runs NFKC normalization on identifiers (as ENS, GitHub, and Unicode IDNA require -- though note that for general web text, NFC is the standard; NFKC is specifically appropriate for identifiers and slug validation), then 31 entries in confusables.txt map the same character to a different target than NFKC. If you're building a confusable map for use after NFKC normalization, those entries are unreachable. NFKC has already transformed the character before your confusable check sees it.
...
*These 31 divergence entries have been submitted to the Unicode Consortium and accepted into [PRI #540](https://www.unicode.org/review/pri540/) for review by the UTC at meeting #187.*
...
*Thanks to [joshdata](https://news.ycombinator.com/user?id=joshdata) on [Hacker News](https://news.ycombinator.com/item?id=47121716) for the [correction on NFC vs NFKC scope](https://news.ycombinator.com/item?id=47152985).*
