...
This post describes discoveries from the SSIM (pixel-based) pipeline. A subsequent [RaySpace](/posts/rayspace-methodology/) scan using vector-outline raycasting confirmed and extended these findings across 245 fonts, including the Han/Katakana pairs (口/ロ, 二/ニ) which appear in the [cross-script results](/posts/rayspace-methodology/#cross-script-breakthroughs).
