...
![14 Latin lowercase letters with their Cyrillic visual doubles, rendered in Arial Unicode. Each pair is shown side by side with RaySpace distance, font coverage, and recommended action tier. The first 11 pairs (w through a) are at distance below 0.05, visually identical in most fonts.](/images/confusable-vision/idn-latin-cyrillic-pairs.png)
...
![Four characters from four scripts that all match the shape of Latin "o". Latin o, Cyrillic о, and Greek omicron are in confusables.txt. Georgian ini (U+10D8) is not, despite being in the Georgian LGR repertoire with no variant blocking.](/images/confusable-vision/idn-georgian-gap.png)
...
![Five Han/Katakana confusable pairs rendered side by side. 二/ニ, 卜/ト, and 口/ロ are visually indistinguishable. 工/エ and 力/カ show increasing but still low distances.](/images/confusable-vision/idn-han-katakana-pairs.png)
