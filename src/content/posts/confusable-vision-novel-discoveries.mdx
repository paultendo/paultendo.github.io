...
*[confusable-vision](https://github.com/paultendo/confusable-vision) is MIT-licensed. The discovery data is CC-BY-4.0. The full candidate analysis, 96-script breakdown, and all render artifacts are in the repo. [namespace-guard](https://github.com/paultendo/namespace-guard) (v0.16.0, zero dependencies, MIT) integrates these discoveries via optional visual weights in `confusableDistance()`.*
