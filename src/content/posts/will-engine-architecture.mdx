...
You could give an LLM the <Term def="The person making the will.">testator</Term>'s details and ask it to draft a will. Name, spouse, two children, a house, some savings, a favourite charity. The model would produce something that reads like a will. It would have clauses and subclauses and formal language. It might even cite the correct <Term def="The formal signing and witnessing of the will. England and Wales requires two witnesses present at the same time.">attestation</Term> requirements.

It would also be wrong.

Not obviously wrong. Not gibberish. Wrong in the ways that matter when someone dies:

- Missing <Term def="A fallback that redirects a gift when the intended beneficiary can't inherit.">substitution clauses</Term> for when a <Term def="Anyone who receives something under the will.">beneficiary</Term> <Term def="Dies before the testator. If a beneficiary predeceases, their gift may lapse.">predeceases</Term> the testator
- Wrong attestation form for the jurisdiction
- No fallback logic when a <Term def="A named asset or sum left to a named person or organisation.">specific gift</Term> fails — does it fall into <Term def="Everything left over after specific gifts, debts, and expenses.">residue</Term>, <Term def="When a gift fails, usually because the beneficiary predeceased the testator.">lapse</Term> entirely, or pass to the beneficiary's children?
...
Every will follows a canonical structure that courts and <Term def="The legal process of proving the will is valid and authorising the executor to act.">probate</Term> registries expect:

1. <Term def="Cancelling all previous wills to avoid conflicts with earlier documents.">Revocation</Term> of prior wills
2. Appointment of <Term def="The person appointed to administer the estate after death. They collect assets, pay debts, and distribute gifts.">executors</Term>
...
5. <Term def="Everything left over after specific gifts, debts, and expenses. Most wills leave the residue to the spouse or children.">Residuary estate</Term> — everything left after the specific gifts
6. Trusts, if needed
7. Administrative powers for the executors
8. Declarations
9. Attestation

Each of these sections exists because of specific conditions. You don't appoint guardians if there are no minor children. You don't usually include a <Term def="Requires a beneficiary to outlive the testator by a set period (commonly 28 days) before inheriting.">survivorship clause</Term> for a gift to a charity, because charities don't predecease anyone (unless you meant if that charity doesn't exist at the time of death).
...
- **Info** — a will that doesn't include a <Term def="Permits a solicitor named as executor to charge fees for their work. Without it, they may have to act for free.">professional charging clause</Term> when a solicitor is named as executor
...
- But what if one of the children *also* predeceases? Does their share pass to their children (<Term def="A distribution method where a deceased beneficiary's share passes down to their children rather than sideways to the other beneficiaries.">per stirpes</Term>), or <Term def="When a deceased beneficiary's share is absorbed by the remaining beneficiaries. The opposite of per stirpes.">accrete</Term> to the surviving child?
- What if both children predecease? Does the estate go to the testator's parents, siblings, or to the Crown as <Term def="Property that passes to the Crown when there is no valid beneficiary and no intestacy heir.">bona vacantia</Term>? (Surely not to the Crown!)
...
Is the house in <Term def="Two ways of co-owning property. Joint tenancy passes automatically to the surviving owner on death. Tenants in common means each share forms part of their estate.">joint tenancy or tenants in common</Term>? The notes don't say. The model flags it.
...
This post uses will-writing terminology that may be unfamiliar. Here's a quick reference.

| Term | Meaning |
|------|---------|
| Testator | The person making the will. |
| Executor | The person appointed to administer the estate after death. They collect assets, pay debts, and distribute gifts. |
| Beneficiary | Anyone who receives something under the will. |
| Specific gift | A named asset or sum left to a named person or organisation. "My house to my spouse" or "£10,000 to Macmillan." |
| Residuary estate | Everything left over after specific gifts, debts, and expenses. Most wills leave the residue to the spouse or children. |
| Predeceases | Dies before the testator. If a beneficiary predeceases, their gift may lapse unless the will provides a substitution. |
| Lapse | When a gift fails, usually because the beneficiary predeceased the testator. A lapsed gift falls into the residuary estate unless the will says otherwise. |
| Substitution clause | A fallback that redirects a gift when the intended beneficiary can't inherit. "To my daughter, or if she predeceases me, to her children." |
| Per stirpes | A distribution method where a deceased beneficiary's share passes down to their children rather than sideways to the other beneficiaries. |
| Accrete | When a deceased beneficiary's share is absorbed by the remaining beneficiaries rather than passing to the deceased's own children. The opposite of per stirpes. |
| Survivorship clause | Requires a beneficiary to outlive the testator by a set period (commonly 28 days) before inheriting. Prevents the estate passing through two sets of probate in quick succession. |
| Issue | Legal term for a person's descendants: children, grandchildren, and so on. |
| Attestation | The formal signing and witnessing of the will. England and Wales requires two witnesses present at the same time. Getting this wrong can invalidate the entire will. |
| Probate | The legal process of proving the will is valid and authorising the executor to act. |
| Bona vacantia | Property that passes to the Crown when there is no valid beneficiary and no intestacy heir. The ultimate fallback nobody wants. |
| Joint tenancy / tenants in common | Two ways of co-owning property. Joint tenancy passes automatically to the surviving owner on death (outside the will). Tenants in common means each owner's share forms part of their estate and can be left by will. |
| Professional charging clause | Permits a solicitor or other professional named as executor to charge fees for their work. Without it, a professional executor may have to act for free. |
| Revocation | Cancelling all previous wills. Almost every will begins with a revocation clause to avoid conflicts with earlier documents. |
