...
**Executor** — the person appointed by the will to administer the estate after death. They collect assets, pay debts, and distribute gifts.

**Beneficiary** — anyone who receives something under the will.

**Specific gift** — a named asset or sum left to a named person or organisation. "My house to my spouse" or "£10,000 to Macmillan" are specific gifts.

**Residuary estate (residue)** — everything left over after specific gifts, debts, and expenses have been dealt with. Most wills leave the residue to the spouse or children.

**Predeceases** — dies before the testator. If a beneficiary predeceases the testator, their gift may lapse unless the will provides a substitution.
...
**Substitution clause** — a fallback that redirects a gift when the intended beneficiary can't inherit. "To my daughter, or if she predeceases me, to her children" is a substitution.

**Per stirpes** — a distribution method where a deceased beneficiary's share passes down to their children (and their children's children) rather than sideways to the other beneficiaries.
...
**Attestation** — the formal signing and witnessing of the will. England and Wales requires two witnesses who are present at the same time. Getting this wrong can invalidate the entire will.

**Probate** — the legal process of proving the will is valid and authorising the executor to act. The probate registry examines the will before granting authority.
...
**Professional charging clause** — a clause permitting a solicitor or other professional named as executor to charge fees for their work. Without it, a professional executor may have to act for free.
