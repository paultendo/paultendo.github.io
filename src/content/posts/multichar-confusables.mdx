...
Next: extending the pipeline to Cyrillic, Greek, and Devanagari bigrams, the IDN-critical scripts where characters *are* in the modern registrable repertoire.
