---
title: "I rendered 1,418 confusable pairs across 230 fonts. Most aren't confusable to the eye."
...
Next: weighted confusable scoring in [namespace-guard](https://github.com/paultendo/namespace-guard), calibrated from these SSIM scores.
