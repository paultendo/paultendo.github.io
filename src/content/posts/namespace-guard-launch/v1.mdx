...
**[Try it in the interactive playground →](https://paultendo.github.io/namespace-guard/)**
...
NFKC Unicode normalisation is on by default. This collapses full-width characters (`ｈｅｌｌｏ` → `hello`), ligatures (`ﬁnance` → `finance`), and other compatibility forms. It's what GitHub, ENS, and the Unicode IDNA standards use. But it doesn't catch homoglyphs. That's what the validator is for.
